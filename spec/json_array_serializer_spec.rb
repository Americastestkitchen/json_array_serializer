...
describe JSONArraySerializer do
  ...
  context 'text without arguments to .new' do
  ...
  context 'text with class argument to .new' do
  ...
  context 'array without arguments to .new' do
  ...
  context 'array with class argument to .new' do
